...
public class TestActivity extends AppCompatActivity {
    ...
    private int quantityOfWords, word, selectedWord = 0, auxiliary, auxiliary2, realAnswers;
    ...
    private void showView(){
        if(drawList.size()> copyDrawList.size()){
            ...
            final int percent2= 100*realAnswers / drawList.size();
            final TextView tvQuantity = findViewById(R.id.textViewQuantity_activity_end);
            final TextView tvPercent = findViewById(R.id.textViewPercent_activity_end);
                    ...
                    for (int i =0; i < realAnswers+1; i++){
                        ...
                        try {
                            ...
                            runOnUiThread(new Runnable() {
                                @Override
                                public void run() {
                                    tvQuantity.setText(auxiliary2+"/"+drawList.size());
                                }
                            });
                        } catch (InterruptedException e){
                            e.printStackTrace();
